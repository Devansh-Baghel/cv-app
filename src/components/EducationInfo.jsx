  ...
  return (
    <div>
      <div>
        ...
        {isEditing ? (
          <div>
            <input type="text" placeholder="Title of Study" value={title} onChange={(e) => setTitle(e.target.value)} />
            <input type="text" placeholder="Name of Acedemic Institution" value={schoolName} onChange={(e) => setSchoolName(e.target.value)} />
        ...
        <button onClick={isEditing ? handleSubmit : handleEdit}>{isEditing ? 'Submit' : 'Edit'}</button>
      </div>
      <div>
        <h2>CV Preview</h2>
        {cvData ? (
